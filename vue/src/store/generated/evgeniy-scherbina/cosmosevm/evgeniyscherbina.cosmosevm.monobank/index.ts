...
import { Balance } from "./module/types/monobank/balance"
import { Params } from "./module/types/monobank/params"
...
export default {
	...
	actions: {
		init({ dispatch, rootGetters }) {
			console.log('Vuex module: evgeniyscherbina.cosmosevm.monobank initialized!')
